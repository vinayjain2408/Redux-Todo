          ...
          additionalData.receivedData.additionalData.map((item, index) => (
            <div key={index} className="Accordions">
              <Accordion>
                ...
                >
                  <Typography>
                    <input className="input-text" type="text" value={item.name} />
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
...
//   const dispatch = useDispatch();
//   // const additionalData = useSelector((state) => state.ListReducer.list.receivedData);
//   const additionalData = useSelector((state) => state.ListReducer.list.map((list) => list.receivedData.additionalData));
...
// {receivedData && additionalData.id === receivedData.id ? (
//   additionalData.map((inp, index) => (
//     <div key={index} className="Accordions">
//       <Accordion>
//         <AccordionSummary
//           expandIcon={<ExpandMoreIcon />}
//           aria-controls={`panel${index + 1}-content`} // Updated to include index in aria-controls
//           id={`panel${index + 1}-header`} // Updated to include index in id
//         >
//           <Typography>
//             <input
...
//   const handleInputKeyPress = (e) => {
//     if (e.key === "Enter" && inputDetail.trim() !== "") {
//       dispatch(pushToArray(receivedData, inputDetail)); 
//       console.log(inputDetail,"detail page array")
//       setInputDetail("");
//     }
//   }
//   console.log(receivedData,'vinay DATA')
...
//        <div className="boxex">
//       {receivedData.additionalData.map((inp, index) => {
//           return (
